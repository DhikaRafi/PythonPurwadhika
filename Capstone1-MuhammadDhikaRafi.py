...
==============================
        ...
        for i in range(n):
            for j in range(0, n-i-1):
                ...
                if (pilihan == 1 and listvespa[j][2] > listvespa[j+1][2]) or \
                   (pilihan == 2 and listvespa[j][2] < listvespa[j+1][2]):
                    listvespa[j], listvespa[j+1] = listvespa[j+1], listvespa[j]
...
======================================
        ...
        for i in range(n):
            for j in range(0, n-i-1):
                ...
                if (pilihan == 1 and listvespa[j][3] < listvespa[j+1][3]) or \
                   (pilihan == 2 and listvespa[j][3] > listvespa[j+1][3]):
                    listvespa[j], listvespa[j+1] = listvespa[j+1], listvespa[j]
